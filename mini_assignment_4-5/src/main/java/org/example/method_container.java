...
public class method_container
{
    ...
    {
        System.setProperty("webdriver.chrome.driver","####clcik on chromedriver and paste relative path");
    ...
    public static WebDriver checkOut() throws Exception
    {
        ...
        BufferedReader br = new BufferedReader(new FileReader("clcik on user_details and paste path"));
